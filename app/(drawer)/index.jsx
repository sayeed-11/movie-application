...
const index = () => {
  ...
  return (
    <View className="flex-1 bg-[#121212] relative">
      <SafeAreaView style={{}} className="absolute z-50">
        <Animated.View
          style={[
            {
              paddingTop: Platform.OS === "ios" ? 50 : getStatusBarHeight(),
              width: Dimensions.get("window").width,
            },
            bgStyle,
          ]}
          className="justify-between w-full flex-row px-5 py-3 absolute z-50  items-center"
        >
          <TouchableOpacity
            onPress={() => {
